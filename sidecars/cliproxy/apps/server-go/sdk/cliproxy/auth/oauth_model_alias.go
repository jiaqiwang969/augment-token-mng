...
//
// Supported channels: gemini-cli, vertex, aistudio, antigravity, auggie, claude, codex, qwen, iflow, kimi.
func OAuthModelAliasChannel(provider, authKind string) string {
	...
	case "codex":
		...
		return "codex"
	case "gemini-cli", "aistudio", "antigravity", "auggie", "qwen", "iflow", "kimi":
		return provider
	default:
		return ""
	}
