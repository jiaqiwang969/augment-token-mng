  ...
  platform: {
    ...
    openai: {
      ...
      codexDialog: {
        ...
        selectedMemberHint: 'Switch the team detail view from a dropdown so only one member card is expanded at a time.',
        ...
        visibleMembersHint: 'This filter drives both the monthly trend chart and the member ranking table.',
