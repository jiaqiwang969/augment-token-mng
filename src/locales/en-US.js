  ...
  platform: {
    ...
    openai: {
      ...
      codexDialog: {
        ...
        gatewayKeysHint: 'The unified /v1 entrypoint authenticates with these keys and breaks request trends down by key.',
        addKey: 'Add Key',
        ...
        monthlyTrendHint: 'Shows the last 30 days of requests and tokens split by external gateway key.',
