export default {
  ...
  tokenList: {
    ...
    proxyPanel: {
      ...
      stopServer: 'Stop API Server',
      apiServer: 'ATM API',
      sidecar: 'CLIProxyAPI Sidecar',
      accounts: 'Usable Accounts',
      baseUrl: 'Base URL',
      baseUrlHint: 'The public gateway stays on http://127.0.0.1:8766/v1. External clients should not use /augment directly.',
      envExport: 'Environment Export',
      copyEnvExport: 'Copy Export',
      copyEnvExportSuccess: 'OPENAI_BASE_URL export copied',
      accessKey: 'Access Key',
      accessKeyHint: 'This external key routes unified /v1 traffic to the Augment sidecar. It is not an Augment raw token.',
      saveKey: 'Save Key',
      saveKeySuccess: 'Access key saved',
      saveKeyFailed: 'Failed to save access key',
      keyPlaceholder: 'Enter or generate an sk- access key',
      showKey: 'Show Key',
      hideKey: 'Hide Key',
      copyKey: 'Copy Key',
      copyKeySuccess: 'Access key copied',
      generateKey: 'Generate Key',
      rotateKey: 'Rotate Key',
      generateKeySuccess: 'Generated a new draft access key',
      unsavedKeyHint: 'This key has not been saved yet',
      envKey: 'Environment Variable',
      codexIntegration: 'Codex Integration',
      integrationHint: 'These snippets are ready for Codex CLI and already target the unified /v1 gateway.',
      curlExample: 'curl Example',
      copyCurl: 'Copy curl',
      copyCurlSuccess: 'curl example copied',
      authPoolSnippet: 'auth-pool.json Snippet',
      copyAuthPool: 'Copy auth-pool',
      copyAuthPoolSuccess: 'auth-pool.json snippet copied',
      configPoolSnippet: 'config-pool.toml Snippet',
      copyConfigPool: 'Copy config-pool',
      copyConfigPoolSuccess: 'config-pool.toml snippet copied',
      serverRunning: 'Running',
      serverStopped: 'Stopped',
      sidecarConfigured: 'Configured',
      sidecarMissing: 'Missing',
      sidecarActive: 'Active',
      sidecarStarting: 'Checking',
      sidecarStandby: 'Standby',
      accountsSummary: '{available} / {total} usable',
      apiServerStopped: 'API server stopped',
      apiServerStoppedHint: 'Start the shared ATM API server before pointing external clients at the unified /v1 gateway.',
      sidecarMissingHint: 'The bundled cliproxy-server binary is not available, so the Augment proxy cannot be used.',
      noAccounts: 'No usable accounts',
      noAccountsHint: 'No Augment accounts currently pass the proxy usability filter. Import accounts or refresh their status first.',
      ready: 'Proxy ready',
      readyHint: 'The unified /v1 entrypoint is ready. The sidecar will start automatically on the first Augment request.',
      active: 'Proxy active',
      activeHint: 'The sidecar is running and healthy. Codex CLI can use it directly now.',
      starting: 'Sidecar degraded',
      startingHint: 'A sidecar process exists but has not passed health checks yet. Refresh the status once to confirm.',
      sidecarAutoStart: 'The sidecar still uses lazy startup and only launches when the first Augment request arrives.',
      accountsHint: 'This usable-account count reuses the same filtering rules as the live Augment proxy behind unified /v1.',
      copyBaseUrl: 'Copy URL',
      copyBaseUrlSuccess: 'Augment proxy URL copied',
      tauriRequired: 'Tauri desktop bridge is unavailable. Start ATM with make dev.',
      loadFailed: 'Failed to load proxy status',
      loadAccessFailed: 'Failed to load access config',
      startSuccess: 'API server started',
      startFailed: 'Failed to start API server',
      stopSuccess: 'API server stopped',
  ...
  platform: {
    ...
    antigravity: {
      ...
      apiService: {
        buttonTooltip: 'Antigravity API Service',
        title: 'Antigravity API Service',
        ...
        storageOverviewHint: 'Shows the Antigravity API log database size together with all-time and recent traffic.',
        storageTotalLogs: 'Total Logs',
        storageDbSize: 'Database Size',
        allTimeRequests: 'All-Time Requests',
        allTimeTokens: 'All-Time Tokens',
        weekRequests: '7-Day Requests',
        weekTokens: '7-Day Tokens',
        monthRequests: '30-Day Requests',
        monthTokens: '30-Day Tokens',
        maintenanceTitle: 'Log Maintenance',
        maintenanceHint: 'Clear the full log store or prune older entries by date. Metrics refresh automatically afterward.',
        clearLogs: 'Clear All Logs',
        clearLogsConfirm: 'Clear all Antigravity request logs? This cannot be undone.',
        clearLogsSuccess: 'All logs cleared',
        clearLogsFailed: 'Failed to clear logs: {error}',
        deleteOldLogs: 'Delete Old Logs',
        deleteOldLogsConfirm: 'Delete logs before {date}?',
        deleteOldLogsSuccess: 'Deleted logs before {date}',
        deleteOldLogsFailed: 'Failed to delete old logs: {error}',
        deleteBeforeDate: 'Delete Before Date',
        deleteBeforeDateHint: 'Pick a cutoff date and ATM will delete logs older than that day.',
        deleteBeforeDateRequired: 'Select a cutoff date first',
        logSummaryTitle: 'Log Summary',
        logSummaryHint: 'Summarizes success, failure, and success rate for the active log filters.',
        modelUsageTitle: 'Model Usage Mix',
        modelUsageHint: 'Summarizes request volume and token share by model for the active log time window.',
        requests: 'Requests',
        successfulRequests: 'Successful Requests',
        failedRequests: 'Failed Requests',
        share: 'Share',
        apiServerRunning: 'Route 8766 enabled',
        apiServerStopped: 'Route 8766 disabled',
        sidecarConfigured: 'Sidecar configured',
        sidecarMissing: 'Sidecar missing',
        sidecarRunning: 'Sidecar running',
        sidecarStopped: 'Sidecar stopped',
        teamMembersTitle: 'Team Member Keys',
        teamMembersHint: 'Manage dedicated Antigravity keys, labels, and export bundles in one place.',
        addMember: 'Add Member',
        editMember: 'Edit Member',
        syncTeamTemplate: 'Sync Team Template',
        exportAllMembersAccess: 'Export All Member Access',
        exportAllMembersAccessFailed: 'Failed to export team access bundle: {error}',
        noTeamMembers: 'No Antigravity member keys yet',
        noTeamMembersHint: 'Sync the built-in team template to create the preset member keys.',
        member: 'Member',
        status: 'Status',
        actions: 'Actions',
        ...
        memberKey: 'Dedicated Member Key',
        keySuffixLabel: 'Key suffix: {suffix}',
        memberNameLabel: 'Member Name',
        memberNamePlaceholder: 'For example: 姜大大',
        memberCodeLabel: 'Member Code',
        memberCodePlaceholder: 'For example: jdd',
        roleTitleLabel: 'Role Label',
        roleTitlePlaceholder: 'For example: Architecture & Trends',
        personaSummaryLabel: 'Persona Summary',
        personaSummaryPlaceholder: 'Summarize this member’s style, responsibilities, and usage pattern',
        colorLabel: 'Identity Color',
        notesLabel: 'Notes',
        notesPlaceholder: 'Add any usage conventions, delivery rhythm, or special notes for this member',
        accessPreviewTitle: 'Access Preview',
        autoGenerateApiKeyHint: 'Leave the key empty when creating a member and ATM will generate one automatically.',
        apiKeyPlaceholder: 'Enter a custom sk-ant- key or leave it empty to auto-generate',
        showApiKey: 'Show',
        hideApiKey: 'Hide',
        generateApiKey: 'Regenerate',
        generateApiKeySuccess: 'Generated a new access key',
        memberNameRequired: 'Member name is required',
        memberCodeRequired: 'Member code is required',
        copyAccessBundle: 'Copy Access Bundle',
        copyEmpty: 'Nothing to copy',
        createKeySuccess: 'Member key created',
        createKeyFailed: 'Failed to create member key: {error}',
        saveKeySuccess: 'Member key saved',
        saveKeyFailed: 'Failed to save member key: {error}',
        updateKeyFailed: 'Failed to update member key: {error}',
        deleteKeyConfirm: 'Delete access key "{name}"?',
        deleteKeySuccess: 'Member key deleted',
        deleteKeyFailed: 'Failed to delete member key: {error}',
        importTeamSuccess: 'Team template synced',
        importTeamFailed: 'Failed to sync team template: {error}',
        loadFailed: 'Failed to load Antigravity API service: {error}',
        logsPlaceholder: 'The logs tab is next in line for database-backed logs and trend charts. This first slice focuses on entry, URLs, key management, and export.',
        analyticsTruncatedHint: 'Member analytics currently use the latest {limit} log samples only.',
        memberUsageTitle: 'Member Usage Overview',
        memberUsageHint: 'Selected members stay linked across the monthly trend and token share chart.',
        memberTokenShare: 'Member Token Share',
        memberTokenShareHint: 'Shows 30-day cumulative token share for the currently visible members.',
        selectedMembersCount: '{count} selected',
        allVisibleMembers: 'All Members',
        ...
        selectedMemberLabel: 'Member Details',
        selectedMemberHint: 'Inspect the current member profile and recent usage.',
        noPersonaSummary: 'No persona summary yet',
        noData: 'No data',
    ...
    openai: {
      ...
      codexDialog: {
        ...
        localServerUrl: 'Local Server URL',
        publicServerUrl: 'Public Server URL',
        relayHealthTitle: 'Relay Health',
        relayHealthHint: 'Local and public relay are checked separately. Auto-repair brings local relay back first, then reconnects the remote forwarding path.',
        relayRefreshNow: 'Check Now',
        relayRepairNow: 'Repair Now',
        relayStatusHealthy: 'Healthy',
        relayStatusLocalDown: 'Local Down',
        relayStatusPublicDown: 'Public Down',
        relayStatusUnknown: 'Unknown',
        relayStatusInProgress: 'Repairing',
        relayStatusLocal: 'Local Relay',
        relayStatusPublic: 'Public Relay',
        relayLastChecked: 'Last Checked',
        relayLastSuccess: 'Last Success',
        relayLastError: 'Last Error',
        relayLastRepairAttempt: 'Last Repair Attempt',
        relayLastRepairResult: 'Last Repair Result',
        relayCooldownUntil: 'Cooldown Until',
        relayRefreshFailed: 'Failed to refresh relay health: {error}',
        relayRepairSuccess: 'Relay repair requested',
        relayRepairFailed: 'Failed to repair relay: {error}',
        relayRepairStillFailing: 'Relay is still unhealthy after the repair attempt',
        apiKey: 'API Key',
        gatewayKeys: 'Access Keys',
        gatewayKeysHint: 'The unified /v1 entrypoint authenticates with these keys and breaks trends down by team member.',
        addKey: 'Add Key',
        noGatewayKeys: 'No gateway keys yet',
        primaryKey: 'Primary',
        enabledKey: 'Enabled',
        disabledKey: 'Disabled',
        ...
        totalAccounts: 'Total Accounts',
        profileNamePlaceholder: 'Give this key a name',
        apiKeyPlaceholder: 'Enter or generate an sk- gateway key',
        showApiKey: 'Show',
        hideApiKey: 'Hide',
        generateApiKey: 'Generate',
        generateApiKeySuccess: 'Generated a new draft access key',
        apiKeyRequired: 'Gateway key is required',
        copyEmpty: 'Nothing to copy',
        ...
        saveKey: 'Save Key',
        saveKeySuccess: 'Access key saved',
        saveKeyFailed: 'Failed to save access key: {error}',
        createKeySuccess: 'Gateway key created',
        createKeyFailed: 'Failed to create gateway key: {error}',
        addMember: 'Add Member',
        editMember: 'Edit Member',
        updateKeyFailed: 'Failed to update gateway key: {error}',
        deleteKeyConfirm: 'Delete gateway key "{name}"?',
        deleteKeySuccess: 'Gateway key deleted',
        deleteKeyFailed: 'Failed to delete gateway key: {error}',
        ...
        switchFailed: 'Switch failed: {error}',
        teamMembersTitle: 'Team Member Keys',
        teamMembersHint: 'Manage the dedicated key, labels, and same-day usage for all 10 members in one place.',
        syncTeamTemplate: 'Sync Team Template',
        exportAllMembersAccess: 'Export All Member Access',
        memberTableTitle: 'Member Usage Overview',
        memberTableHint: 'Identity, dedicated key, and 30-day usage are merged into one table. Selected rows also filter the trend chart.',
        addCustomKey: 'Add Custom Key',
        noTeamMembers: 'Team template has not been imported yet',
        noTeamMembersHint: 'Click "Sync Team Template" to create the 10 preset member keys automatically.',
        selectedMemberLabel: 'Selected Member',
        selectedMemberHint: 'Click a member row in the table above to inspect the detailed card here.',
        ...
        colorLabel: 'Identity Color',
        notesLabel: 'Notes',
        notesPlaceholder: 'Add usage conventions, delivery rhythm, or any special notes for this member',
        accessPreviewTitle: 'Access Preview',
        autoGenerateApiKeyHint: 'Leave the key empty when creating a member and ATM will generate one automatically.',
        memberNameRequired: 'Member name is required',
        memberCodeRequired: 'Member code is required',
        saveMember: 'Save Member Info',
        copyAccessBundle: 'Copy Access Bundle',
        resetTeamDefaults: 'Reset to Template',
        analyticsTruncatedHint: 'Log sampling was truncated. Rankings are currently based on the latest {limit} records.',
        customKeysTitle: 'Custom Keys',
        customKeysHint: 'Reserved for temporary accounts, contractors, or special use cases without affecting the 10 fixed members.',
        noCustomKeys: 'No custom keys yet',
        visibleMembersLabel: 'Visible Members',
        visibleMembersHint: 'These selections drive the monthly trend chart, while the focused member detail comes from the table row above.',
        allVisibleMembers: 'All Members',
        visibleMembersCount: '{count} members selected',
        enabledMembers: 'Enabled Members',
        memberRankingTitle: 'Member Ranking',
        memberRankingHint: 'Sorted by total tokens and requests over the last 30 days so heavy usage is obvious.',
        noMemberRankingData: 'No recent member activity data',
        avgDuration: 'Avg Duration',
        tokenBreakdown: 'Token Breakdown',
        inputTokensShort: 'In',
        outputTokensShort: 'Out',
        ...
        importTeamSuccess: 'Team template synced',
        importTeamFailed: 'Failed to sync team template: {error}',
        resetTeamMemberSuccess: 'Member template restored',
        resetTeamMemberFailed: 'Failed to restore member template: {error}'
      },
