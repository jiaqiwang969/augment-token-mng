export default {
  ...
  tokenList: {
    ...
    proxyPanel: {
      title: 'Augment 代理',
      refreshStatus: '刷新状态',
      startServer: '启动 API 服务',
      stopServer: '停止 API 服务',
      apiServer: 'ATM API',
      sidecar: 'CLIProxyAPI Sidecar',
      accounts: '可用帐号',
      baseUrl: 'Base URL',
      baseUrlHint: '统一对外入口固定为 http://127.0.0.1:8766/v1，外部客户端不再直接暴露 /augment 路径。',
      envExport: '环境变量',
      copyEnvExport: '复制导出命令',
      copyEnvExportSuccess: 'OPENAI_BASE_URL 导出命令已复制',
      accessKey: '访问 Key',
      accessKeyHint: '这个外部 Key 用来把统一 /v1 请求路由到 Augment sidecar，不是 Augment 原始 token。',
      saveKey: '保存 Key',
      saveKeySuccess: '访问 Key 已保存',
      saveKeyFailed: '保存访问 Key 失败',
      keyPlaceholder: '输入或生成 sk- 开头的访问 Key',
      showKey: '显示 Key',
      hideKey: '隐藏 Key',
      copyKey: '复制 Key',
      copyKeySuccess: '访问 Key 已复制',
      generateKey: '生成 Key',
      rotateKey: '轮换 Key',
      generateKeySuccess: '已生成新的访问 Key 草稿',
      unsavedKeyHint: '当前 Key 尚未保存',
      envKey: '环境变量名',
      codexIntegration: 'Codex 接入',
      integrationHint: '下面给的是可直接接入 Codex CLI 的示例，base URL 和 key 都已经按统一 /v1 入口生成。',
      curlExample: 'curl 示例',
      copyCurl: '复制 curl',
      copyCurlSuccess: 'curl 示例已复制',
      authPoolSnippet: 'auth-pool.json 片段',
      copyAuthPool: '复制 auth-pool',
      copyAuthPoolSuccess: 'auth-pool.json 片段已复制',
      configPoolSnippet: 'config-pool.toml 片段',
      copyConfigPool: '复制 config-pool',
      copyConfigPoolSuccess: 'config-pool.toml 片段已复制',
      serverRunning: '运行中',
      serverStopped: '未启动',
      sidecarConfigured: '已配置',
      sidecarMissing: '缺失',
      sidecarActive: '运行中',
      sidecarStarting: '检查中',
      sidecarStandby: '待命',
      accountsSummary: '{available} / {total} 可用',
      apiServerStopped: 'API 服务未启动',
      apiServerStoppedHint: '先启动 ATM 的共享 API 服务，外部客户端才能通过统一 /v1 入口访问 Augment 代理。',
      sidecarMissingHint: '当前没有找到 bundled cliproxy-server，Augment 代理暂时不可用。',
      noAccounts: '没有可用帐号',
      noAccountsHint: '当前 Augment 帐号池里没有通过可用性筛选的帐号，请先导入或刷新帐号状态。',
      ready: '代理已就绪',
      readyHint: '统一 /v1 入口已经准备好，sidecar 会在首个 Augment 请求到来时自动启动。',
      active: '代理运行中',
      activeHint: 'sidecar 已经启动并通过健康检查，可以直接给 Codex CLI 使用。',
      starting: 'sidecar 异常',
      startingHint: '检测到 sidecar 进程存在，但健康检查还没有通过，可以先刷新一次状态确认。',
      sidecarAutoStart: 'sidecar 仍采用懒启动策略，首个 Augment 请求才会真正拉起进程。',
      accountsHint: '这里的可用帐号数量与统一 /v1 下 Augment 代理实际使用的过滤规则保持一致。',
      copyBaseUrl: '复制地址',
      copyBaseUrlSuccess: 'Augment 代理地址已复制',
      tauriRequired: '当前不在 Tauri 桌面环境中，请使用 make dev 启动 ATM。',
      loadFailed: '加载代理状态失败',
      loadAccessFailed: '加载访问配置失败',
      startSuccess: 'API 服务已启动',
      startFailed: '启动 API 服务失败',
      stopSuccess: 'API 服务已停止',
      stopFailed: '停止 API 服务失败'
    },
  },
  tokenCard: {
    banned: '已封禁',
  ...
  platform: {
    ...
    antigravity: {
      ...
      apiService: {
        buttonTooltip: 'Antigravity API 服务',
        title: 'Antigravity API 服务',
        tabOverview: '总览',
        tabRequestLogs: '请求日志',
        refresh: '刷新',
        ...
        storageOverviewHint: '这里展示 Antigravity API 服务日志库的体量，以及累计请求与近期趋势。',
        storageTotalLogs: '日志总数',
        storageDbSize: '数据库大小',
        allTimeRequests: '累计请求',
        allTimeTokens: '累计 Token',
        weekRequests: '7 天请求',
        weekTokens: '7 天 Token',
        monthRequests: '30 天请求',
        monthTokens: '30 天 Token',
        maintenanceTitle: '日志维护',
        maintenanceHint: '支持一键清空，或按日期裁剪旧日志；操作后会自动刷新统计。',
        clearLogs: '清空全部日志',
        clearLogsConfirm: '确认清空全部 Antigravity 请求日志吗？此操作不可撤销。',
        clearLogsSuccess: '已清空全部日志',
        clearLogsFailed: '清空日志失败: {error}',
        deleteOldLogs: '删除旧日志',
        deleteOldLogsConfirm: '确认删除 {date} 之前的日志吗？',
        deleteOldLogsSuccess: '已删除 {date} 之前的日志',
        deleteOldLogsFailed: '删除旧日志失败: {error}',
        deleteBeforeDate: '删除截止日期',
        deleteBeforeDateHint: '选择一个日期，系统会删除该日期之前的历史日志。',
        deleteBeforeDateRequired: '请先选择删除截止日期',
        logSummaryTitle: '日志摘要',
        logSummaryHint: '按当前日志筛选条件汇总成功、失败与成功率。',
        modelUsageTitle: '模型使用分布',
        modelUsageHint: '按当前日志时间范围汇总各模型的请求量与 Token 占比。',
        requests: '请求数',
        successfulRequests: '通过数',
        failedRequests: '失败数',
        share: '占比',
        apiServerRunning: '8766 路由已启用',
        apiServerStopped: '8766 路由未启用',
        sidecarConfigured: 'sidecar 已配置',
        sidecarMissing: 'sidecar 未配置',
        sidecarRunning: 'sidecar 运行中',
        sidecarStopped: 'sidecar 未运行',
        teamMembersTitle: '团队成员 Key',
        teamMembersHint: 'Antigravity 团队的专属 Key、标签和导出配置在这里统一管理。',
        addMember: '新增成员',
        editMember: '编辑成员',
        syncTeamTemplate: '同步团队模板',
        exportAllMembersAccess: '导出全员接入信息',
        exportAllMembersAccessFailed: '导出全员接入信息失败: {error}',
        noTeamMembers: '还没有 Antigravity 成员 Key',
        noTeamMembersHint: '点击“同步团队模板”后会自动创建预置成员 Key。',
        member: '成员',
        status: '状态',
        actions: '操作',
        keySuffix: 'Key 尾号',
        ...
        disabledKey: '停用',
        memberKey: '成员专属 Key',
        keySuffixLabel: 'Key 尾号：{suffix}',
        memberNameLabel: '成员名称',
        memberNamePlaceholder: '例如：姜大大',
        memberCodeLabel: '成员代号',
        memberCodePlaceholder: '例如：jdd',
        roleTitleLabel: '角色标签',
        roleTitlePlaceholder: '例如：架构与趋势',
        personaSummaryLabel: '人物画像',
        personaSummaryPlaceholder: '概括这个成员的风格、职责和使用倾向',
        colorLabel: '识别颜色',
        notesLabel: '备注',
        notesPlaceholder: '补充这个成员的使用约定、交付节奏或特殊说明',
        accessPreviewTitle: '接入预览',
        autoGenerateApiKeyHint: '创建成员时可留空，系统会自动生成专属访问 Key。',
        apiKeyPlaceholder: '输入或留空以自动生成 sk-ant- 开头的访问 Key',
        showApiKey: '显示',
        hideApiKey: '隐藏',
        generateApiKey: '重新生成',
        generateApiKeySuccess: '已生成新的访问 Key',
        memberNameRequired: '请先填写成员名称',
        memberCodeRequired: '请先填写成员代号',
        copyAccessBundle: '复制接入配置',
        copyEmpty: '没有可复制的内容',
        createKeySuccess: '已新增成员 Key',
        createKeyFailed: '新增成员 Key 失败: {error}',
        saveKeySuccess: '成员 Key 已保存',
        saveKeyFailed: '保存成员 Key 失败: {error}',
        updateKeyFailed: '更新成员 Key 失败: {error}',
        deleteKeyConfirm: '确认删除访问 Key “{name}”？',
        deleteKeySuccess: '成员 Key 已删除',
        deleteKeyFailed: '删除成员 Key 失败: {error}',
        importTeamSuccess: '团队模板已同步',
        importTeamFailed: '同步团队模板失败: {error}',
        loadFailed: '加载 Antigravity API 服务失败: {error}',
        logsPlaceholder: '日志页下一步接入数据库日志与趋势图，当前先完成入口、URL、Key 管理和导出能力。',
        analyticsTruncatedHint: '成员分析基于最近 {limit} 条日志样本，超过部分未纳入当前总览。',
        memberUsageTitle: '成员使用总览',
        memberUsageHint: '勾选成员后，月度趋势和 Token 占比会同步联动。',
        memberTokenShare: '成员 Token 占比',
        memberTokenShareHint: '按当前可见成员统计近 30 天累计 Token。',
        selectedMembersCount: '已选 {count} 位成员',
        allVisibleMembers: '全部成员',
        selectAllMembers: '全选',
        clearSelection: '清空',
        todayRequests: '今日请求',
        todayTokens: '今日 Token',
        thirtyDayTokens: '30 天 Token',
        lastActive: '最近活跃',
        successRate: '成功率',
        avgDuration: '平均耗时',
        selectedMemberLabel: '成员详情',
        selectedMemberHint: '查看当前成员的角色信息与最近使用情况。',
        noPersonaSummary: '暂无人物画像',
        noData: '暂无数据',
        logsTitle: '请求日志',
        rangeToday: '今日',
        range7d: '7 天',
    ...
    openai: {
      ...
      codexDialog: {
        ...
        localServerUrl: '本地服务 URL',
        publicServerUrl: '公网服务 URL',
        relayHealthTitle: 'Relay 健康状态',
        relayHealthHint: '本机 relay 与公网 relay 分层检查；自动修复会先拉起本机，再尝试重连远端转发。',
        relayRefreshNow: '立即检查',
        relayRepairNow: '立即修复',
        relayStatusHealthy: '健康',
        relayStatusLocalDown: '本机异常',
        relayStatusPublicDown: '公网异常',
        relayStatusUnknown: '未检查',
        relayStatusInProgress: '修复中',
        relayStatusLocal: '本机 Relay',
        relayStatusPublic: '公网 Relay',
        relayLastChecked: '最近检查',
        relayLastSuccess: '最近成功',
        relayLastError: '最近错误',
        relayLastRepairAttempt: '最近修复尝试',
        relayLastRepairResult: '最近修复结果',
        relayCooldownUntil: '冷却到',
        relayRefreshFailed: '检查 relay 失败: {error}',
        relayRepairSuccess: '已提交 relay 修复任务',
        relayRepairFailed: '修复 relay 失败: {error}',
        relayRepairStillFailing: '修复尝试已结束，但 relay 仍未恢复',
        apiKey: 'API Key',
        gatewayKeys: '访问 Key',
        gatewayKeysHint: '统一 /v1 入口会按 Key 鉴权，并把趋势按成员维度拆开统计。',
        addKey: '新增 Key',
        noGatewayKeys: '还没有外部访问 Key',
        primaryKey: '主 Key',
        enabledKey: '启用',
        disabledKey: '停用',
        poolStrategy: '选择策略',
        ...
        selectAccount: '选择账号',
        totalAccounts: '总账号',
        profileNamePlaceholder: '给这个 Key 起个名字',
        apiKeyPlaceholder: '输入或生成 sk- 开头的访问 Key',
        showApiKey: '显示',
        hideApiKey: '隐藏',
        generateApiKey: '生成',
        generateApiKeySuccess: '已生成新的访问 Key 草稿',
        apiKeyRequired: '请先填写访问 Key',
        copyEmpty: '没有可复制的内容',
        saveConfig: '保存配置',
        ...
        saveKey: '保存 Key',
        saveKeySuccess: '访问 Key 已保存',
        saveKeyFailed: '保存访问 Key 失败: {error}',
        createKeySuccess: '已新增访问 Key',
        createKeyFailed: '新增访问 Key 失败: {error}',
        addMember: '新增成员',
        editMember: '编辑成员',
        updateKeyFailed: '更新访问 Key 失败: {error}',
        deleteKeyConfirm: '确认删除访问 Key “{name}”？',
        deleteKeySuccess: '访问 Key 已删除',
        deleteKeyFailed: '删除访问 Key 失败: {error}',
        ...
        switchFailed: '切换失败: {error}',
        teamMembersTitle: '团队成员 Key',
        teamMembersHint: '10 人小队的专属 Key、标签和当日使用情况都在这里统一管理。',
        syncTeamTemplate: '同步团队模板',
        exportAllMembersAccess: '导出全员接入信息',
        memberTableTitle: '成员使用总览',
        memberTableHint: '成员信息、专属 Key 与近 30 天使用数据合并展示，勾选行会同步过滤趋势图。',
        addCustomKey: '新增自定义 Key',
        noTeamMembers: '还没有导入团队模板',
        noTeamMembersHint: '点击“同步团队模板”后会自动创建 10 个预置成员 Key。',
        selectedMemberLabel: '当前查看成员',
        selectedMemberHint: '点击上方表格中的成员行，即可在这里查看详细信息。',
        selectMember: '选择成员',
        noPersonaSummary: '暂无成员画像',
        todayRequests: '今日请求',
        todayTokens: '今日 Token',
        thirtyDayTokens: '30 天 Token',
        successRate: '成功率',
        ...
        saveMember: '保存成员信息',
        copyAccessBundle: '复制接入配置',
        resetTeamDefaults: '恢复模板',
        analyticsTruncatedHint: '日志样本已截断，当前基于最近 {limit} 条记录生成排名。',
        customKeysTitle: '自定义 Key',
        customKeysHint: '保留给临时账号、外包账号或特殊用途，不影响 10 位固定成员。',
        noCustomKeys: '还没有自定义 Key',
        visibleMembersLabel: '可见成员',
        visibleMembersHint: '这里的勾选会同步影响月度趋势；成员详情由上方表格行决定。',
        allVisibleMembers: '全部成员',
        visibleMembersCount: '已选 {count} 位成员',
        enabledMembers: '已启用成员',
        memberRankingTitle: '成员使用排行',
        memberRankingHint: '按最近 30 天累计 Token 和请求量排序，方便看谁在高频使用。',
        noMemberRankingData: '最近暂无成员使用数据',
        avgDuration: '平均耗时',
        tokenBreakdown: 'Token 明细',
        inputTokensShort: '输',
        outputTokensShort: '出',
        ...
        importTeamSuccess: '团队模板已同步',
        importTeamFailed: '同步团队模板失败: {error}',
        resetTeamMemberSuccess: '已恢复成员默认模板',
        resetTeamMemberFailed: '恢复成员默认模板失败: {error}'
      },
